...
import br.com.zup.Relacionamentos.turma.dtos.TurmaDetailDTO;
...
public class TurmaController {
    ...
    @PutMapping
    public TurmaDetailDTO matricularAluno(@RequestBody MatriculaDTO matricula){
        Turma turma = turmaService.vincularAlunoNaTurma(matricula.getAlunoId(), matricula.getTurmaId());
        return modelMapper.map(turma, TurmaDetailDTO.class);
    }
}
